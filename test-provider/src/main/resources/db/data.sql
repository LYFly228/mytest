...
CREATE TABLE IF NOT EXISTS user(
    id int  not null primary key,    code varchar(255) not null ,    create_by varchar(255) not null ,    create_time varchar(255) not null ,    name varchar(255) not null ,    status varchar(255) not null ,    update_by varchar(255) not null ,    update_time varchar(255) not null ,    system_tenant varchar(255) not null ,    domain varchar(255) not null ,    dr int  not null );
